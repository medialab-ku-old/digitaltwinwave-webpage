...
export default function Contact() {
    ...
    return (
        <main className="w-screen xl:w-5xl mx-auto">
            ...
            <div className="mt-10 xl:mt-15 mb-15 xl:flex justify-center">
            ...
            <motion.div className="mt-10 xl:mt-15 mb-20 h-fit"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5 }}>

                <div className="w-[90vw] xl:w-2xl aspect-square xl:aspect-5/3 mx-auto overflow-hidden rounded-lg border border-slate-200">
                    <Map id="map"
                        center={{
                            lat: 37.584495,
                            lng: 127.028308
